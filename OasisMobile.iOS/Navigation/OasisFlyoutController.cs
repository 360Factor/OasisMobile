...
namespace OasisMobile.iOS
{
	public class OasisFlyoutController : FlyoutNavigationController
	{
		...
		public OasisFlyoutController () : base()
		{
			...
			NavigationRoot = new RootElement ("Navigation") {
				new Section () {
					...
					{ 
						...
						TextColor = AppConfig.FlyoutNavTheme.TextColor,
						Image = new UIImage(UIImage.FromBundle (AppConfig.FlyoutNavTheme.ExamIconPath).CGImage,2,UIImageOrientation.Up)
					},
					new StyledStringElement ("Settings")    
					{ 
						BackgroundColor = UIColor.Clear, 
						TextColor = AppConfig.FlyoutNavTheme.TextColor,
						Image = new UIImage(UIImage.FromBundle (AppConfig.FlyoutNavTheme.SettingIconPath).CGImage,2,UIImageOrientation.Up)
					},
					new StyledStringElement ("Support")
					{ 
						BackgroundColor = UIColor.Clear, 
						TextColor = AppConfig.FlyoutNavTheme.TextColor,
						Image = new UIImage(UIImage.FromBundle (AppConfig.FlyoutNavTheme.SupportIconPath).CGImage,2,UIImageOrientation.Up)
					},
					new StyledStringElement ("About")
					{ 
						BackgroundColor = UIColor.Clear, 
						TextColor = AppConfig.FlyoutNavTheme.TextColor,
						Image = new UIImage(UIImage.FromBundle (AppConfig.FlyoutNavTheme.AboutIconPath).CGImage,2,UIImageOrientation.Up)
					}
				}
			};
			...
			NavigationTableView.BackgroundView = new UIImageView (UIImage.FromBundle (AppConfig.FlyoutNavTheme.BackgroundImagePath));
			NavigationTableView.SeparatorColor = AppConfig.FlyoutNavTheme.SeparatorColor;
