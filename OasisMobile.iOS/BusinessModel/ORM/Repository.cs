    ...
    public class Repository : SQLiteConnection
    {
        ...
        private void CreateDatabase()
        {
            ...
            this.Execute("CREATE TABLE IF NOT EXISTS [ExamAccess] ( " +
                ...
                "  [fkUserID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
                "  [fkExamID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
            ...
            this.Execute("CREATE TABLE IF NOT EXISTS [Image] ( " +
                "  [pkImageID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
                "  [fkQuestionID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
            ...
            this.Execute("CREATE TABLE IF NOT EXISTS [Question] ( " +
                ...
                "  [fkCategoryID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
                "  [fkExamID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
            ...
            this.Execute("CREATE TABLE IF NOT EXISTS [UserAnswerOption] ( " +
                ...
                "  [fkUserQuestionID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
                "  [fkAnswerOptionID] INTEGER NOT NULL ON CONFLICT ROLLBACK,  " +
